import{_ as e,o as i,c as l,b as n}from"./app-a60018d3.js";const s={},d=n(`<h2 id="key操作" tabindex="-1"><a class="header-anchor" href="#key操作" aria-hidden="true">#</a> Key操作</h2><div class="language-redis line-numbers-mode" data-ext="redis"><pre class="language-redis"><code>$ select
-- 切换数据库
$ dbsize
-- 查看当前数据库key的数量
$ flushdb

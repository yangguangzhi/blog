import{_ as n,o as i,c as a,b as s,a as e}from"./app-a60018d3.js";const l={},d=s(`<h2 id="redis主从复制" tabindex="-1"><a class="header-anchor" href="#redis主从复制" aria-hidden="true">#</a> Redis主从复制</h2><p>主从复制，主机数据更新后根据一定的配置策略，同步到从服务器上。master/slaver机制，master以写为主，slaver以读为主</p><ul><li>读写分离，性能扩展</li><li>容灾快速恢复</li></ul><h3 id="步骤" tabindex="-1"><a class="header-anchor" href="#步骤" aria-hidden="true">#</a> 步骤</h3><ol><li>拷贝多个Redis.conf，配置一主（写）两从（读）</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 1</span>
